...
(function () {
    (function (p) {
        ...
        (function (p) { "function" === typeof require && "object" === typeof exports && "object" === typeof module ? p(module.exports || exports) : "function" === typeof define && define.amd ? define(["exports"], p) : p(A.ko = {}); })(function (z) {
            ...
            function N(a, c) { var d; return function () { d || (d = setTimeout(function () { d = p; a(); }, c)); }; }
            function O(a, c) {
                var d;
                return function () {
                    clearTimeout(d);
            ...
            function H(b, c, d, e) { a.d[b] = { init: function (b, h, g, k, l) { var n, r; a.ba(function () { var g = a.a.c(h()), k = !d !== !g, s = !r; if (s || c || k !== n)
                    s && a.ca.fa() && (r = a.a.lb(a.e.childNodes(b), !0)), k ? (s || a.e.U(b, a.a.lb(r)), a.gb(e ? e(l, g) : l, b)) : a.e.da(b), n = k; }, null, { G: b }); return { controlsDescendantBindings: !0 }; } }; a.g.aa[b] = !1; a.e.Q[b] = !0; }
            ...
            a.a = function () {
                ...
                var g = { propertychange: !0 }, k = w && function () { for (var a = 3, b = w.createElement("div"), c = b.getElementsByTagName("i"); b.innerHTML = "\x3c!--[if gt IE " + ++a + "]><i></i><![endif]--\x3e", c[0];)
                    ; return 4 < a ? a : p; }();
                return { mb: ["authenticity_token", /^__RequestVerificationToken(_.*)?$/], r: function (a, b) { for (var c = 0, d = a.length; c < d; c++)
                        b(a[c], c); }, l: function (a, b) {
                        ...
                        for (var c = 0, d = a.length; c < d; c++)
                            if (a[c] ===
                                ...
                                return c;
                        return -1;
                    }, hb: function (a, b, c) { for (var d = 0, e = a.length; d < e; d++)
                        if (b.call(c, a[d], d))
                            return a[d]; return null; }, ma: function (b, c) { var d = a.a.l(b, c); 0 < d ? b.splice(d, 1) : 0 === d && b.shift(); }, ib: function (b) { b = b || []; for (var c = [], d = 0, e = b.length; d < e; d++)
                        0 > a.a.l(c, b[d]) && c.push(b[d]); return c; }, ya: function (a, b) { a = a || []; for (var c = [], d = 0, e = a.length; d < e; d++)
                        c.push(b(a[d], d)); return c; }, la: function (a, b) { a = a || []; for (var c = [], d = 0, e = a.length; d < e; d++)
                        b(a[d], d) && c.push(a[d]); return c; }, $: function (a, b) {
                        if (b instanceof Array)
                            ...
                            for (var c = 0, d = b.length; c < d; c++)
                                a.push(b[c]);
                        return a;
                    }, Y: function (b, c, d) { var e = a.a.l(a.a.Sa(b), c); 0 > e ? d && b.push(c) : d || b.splice(e, 1); }, na: e, extend: c, ra: d, sa: e ? d : c, A: b, Oa: function (a, b) { if (!a)
                        return a; var c = {}, d; for (d in a)
                        a.hasOwnProperty(d) && (c[d] = b(a[d], d, a)); return c; }, Fa: function (b) { for (; b.firstChild;)
                        a.removeNode(b.firstChild); }, ec: function (b) { b = a.a.R(b); for (var c = w.createElement("div"), d = 0, e = b.length; d < e; d++)
                        c.appendChild(a.M(b[d])); return c; }, lb: function (b, c) {
                        ...
                        return a;
                    }, Db: function (a, b) { 7 > k ? a.setAttribute("selected", b) : a.selected = b; }, ta: function (a) { return null === a || a === p ? "" : a.trim ? a.trim() : a.toString().replace(/^[\s\xa0]+|[\s\xa0]+$/g, ""); }, oc: function (b, c) { for (var d = [], e = (b || "").split(c), g = 0, k = e.length; g < k; g++) {
                        var h = a.a.ta(e[g]);
                        "" !== h && d.push(h);
                    } return d; }, kc: function (a, b) { a = a || ""; return b.length > a.length ? !1 : a.substring(0, b.length) === b; }, Sb: function (a, b) {
                        if (a === b)
                            return !0;
                        if (11 === a.nodeType)
                            return !1;
                    ...
                    }, c: function (b) { return a.v(b) ? b() : b; }, Sa: function (b) { return a.v(b) ? b.o() : b; }, ua: function (b, c, d) { if (c) {
                        var e = /\S+/g, g = b.className.match(e) || [];
                        a.a.r(c.match(e), function (b) { a.a.Y(g, b, d); });
                        b.className = g.join(" ");
                    } }, Xa: function (b, c) { var d = a.a.c(c); if (null === d || d === p)
                        d = ""; var e = a.e.firstChild(b); !e || 3 != e.nodeType || a.e.nextSibling(e) ? a.e.U(b, [b.ownerDocument.createTextNode(d)]) : e.data = d; a.a.Vb(b); }, Cb: function (a, b) { a.name = b; if (7 >= k)
                        try {
                            a.mergeAttributes(w.createElement("<input name='" + a.name + "'/>"), !1);
                        }
                        catch (c) { } }, Vb: function (a) { 9 <= k && (a = 1 == a.nodeType ? a : a.parentNode, a.style && (a.style.zoom = a.style.zoom)); }, Tb: function (a) { if (k) {
                        var b = a.style.width;
                        a.style.width = 0;
                        a.style.width = b;
                    } }, ic: function (b, c) {
                        ...
                        for (var d = [], e = b; e <= c; e++)
                            d.push(e);
                        return d;
                    }, R: function (a) { for (var b = [], c = 0, d = a.length; c < d; c++)
                        b.push(a[c]); return b; }, mc: 6 === k, nc: 7 === k, oa: k, ob: function (b, c) { for (var d = a.a.R(b.getElementsByTagName("input")).concat(a.a.R(b.getElementsByTagName("textarea"))), e = "string" == typeof c ? function (a) { return a.name === c; } : function (a) { return c.test(a.name); }, g = [], k = d.length - 1; 0 <= k; k--)
                        e(d[k]) && g.push(d[k]); return g; }, fc: function (b) {
                        return "string" == typeof b && (b = a.a.ta(b)) ? C && C.parse ? C.parse(b) : (new Function("return " + b))() :
                            null;
                    }, Ya: function (b, c, d) { if (!C || !C.stringify)
                        throw Error("Cannot find JSON.stringify(). Some browsers (e.g., IE < 8) don't support it natively, but you can overcome this by adding a script reference to json2.js, downloadable from http://www.json.org/json2.js"); return C.stringify(a.a.c(b), c, d); }, gc: function (c, d, e) {
                        e = e || {};
                        ...
                        b(g, function (a, b) { var c = w.createElement("input"); c.name = a; c.value = b; y.appendChild(c); });
            ...
            a.a.f = new function () {
                function a(b, h) { var g = b[d]; if (!g || "null" === g || !e[g]) {
                    if (!h)
                        return p;
                    g = b[d] = "ko" + c++;
                    e[g] = {};
                ...
                return { get: function (c, d) { var e = a(c, !1); return e === p ? p : e[d]; }, set: function (c, d, e) { if (e !== p || a(c, !1) !== p)
                        a(c, !0)[d] = e; }, clear: function (a) { var b = a[d]; return b ? (delete e[b], a[d] = null, !0) : !1; }, L: function () { return c++ + d; } };
            };
            a.b("utils.domData", a.a.f);
            a.b("utils.domData.clear", a.a.f.clear);
            a.a.u = new function () {
                function b(b, c) { var e = a.a.f.get(b, d); e === p && c && (e = [], a.a.f.set(b, d, e)); return e; }
                function c(d) {
                    var e = b(d, !1);
                    if (e)
                ...
                return { ja: function (a, c) { if ("function" != typeof c)
                        throw Error("Callback must be a function"); b(a, !0).push(c); }, Ab: function (c, e) { var k = b(c, !1); k && (a.a.ma(k, e), 0 == k.length && a.a.f.set(c, d, p)); }, M: function (b) { if (e[b.nodeType] && (c(b), f[b.nodeType])) {
                        var d = [];
            ...
            (function () {
                ...
                a.a.Va = function (b, c) { a.a.Fa(b); c = a.a.c(c); if (null !== c && c !== p)
            ...
            a.w = function () {
                ...
                var c = {};
                return { Na: function (a) { if ("function" != typeof a)
                        throw Error("You can only pass a function to ko.memoization.memoize()"); var b = (4294967296 * (1 + Math.random()) | 0).toString(16).substring(1) + (4294967296 * (1 + Math.random()) | 0).toString(16).substring(1); c[b] = a; return "\x3c!--[ko_memo:" + b + "]--\x3e"; }, Hb: function (a, b) { var f = c[a]; if (f === p)
            ...
            a.b("extenders", a.Ga);
            a.Fb = function (b, c, d) { this.target = b; this.za = c; this.Qb = d; this.sb = !1; a.s(this, "dispose", this.F); };
            a.Fb.prototype.F = function () { this.sb = !0; this.Qb(); };
            a.N = function () {
                a.a.sa(this, a.N.fn);
                this.H =
                    {};
            ...
            var F = "change";
            z = { V: function (b, c, d) { var e = this; d = d || F; var f = new a.Fb(e, c ? b.bind(c) : b, function () { a.a.ma(e.H[d], f); }); e.o && e.o(); e.H[d] || (e.H[d] = []); e.H[d].push(f); return f; }, notifySubscribers: function (b, c) { c = c || F; if (this.qb(c))
                    try {
                        a.k.jb();
            ...
            a.ca = a.k = function () {
                ...
                function c() { e = d.pop(); }
                var d = [], e, f = 0;
                return { jb: b, end: c, zb: function (b) { if (e) {
                        if (!a.tb(b))
                            throw Error("Only subscribable things can act as dependencies");
                        e.za(b, b.Kb || (b.Kb = ++f));
                    } }, t: function (a, d, e) { try {
            ...
            a.m = function (b) {
                function c() { if (0 < arguments.length)
                    return c.Ka(d, arguments[0]) && (c.P(), d = arguments[0], c.O()), this; a.k.zb(c); return d; }
                var d = b;
                a.N.call(c);
                a.a.sa(c, a.m.fn);
            ...
            a.T.fn = { remove: function (b) { for (var c = this.o(), d = [], e = "function" != typeof b || a.v(b) ? function (a) { return a === b; } : b, f = 0; f < c.length; f++) {
                    var h = c[f];
                    e(h) && (0 === d.length && this.P(), d.push(h), c.splice(f, 1), f--);
                } d.length && this.O(); return d; }, removeAll: function (b) { if (b === p) {
                    var c = this.o(), d = c.slice(0);
                    this.P();
                    c.splice(0, c.length);
                    this.O();
                    return d;
                } return b ? this.remove(function (c) { return 0 <= a.a.l(b, c); }) : []; }, destroy: function (b) {
                    var c = this.o(), d = "function" != typeof b || a.v(b) ? function (a) { return a === b; } : b;
                    this.P();
            ...
            a.a.r(["slice"], function (b) { a.T.fn[b] = function () { var a = this(); return a[b].apply(a, arguments); }; });
            ...
            a.Ga.trackArrayChanges = function (b) {
                function c() {
                    if (!d) {
                        ...
                        b.notifySubscribers = function (a, b) { b && b !== F || ++f; return c.apply(this, arguments); };
                        var k = [].concat(b.o() || []);
                        e = null;
                        b.V(function (c) {
                            c = [].concat(c || []);
                ...
                if (!b.kb) {
                    ...
                    b.V = b.subscribe = function (a, b, d) { d === I && c(); return h.apply(this, arguments); };
                    b.kb = function (b, c, l) {
            ...
            a.ba = a.h = function (b, c, d) {
                function e() { q = !0; a.a.A(v, function (a, b) { b.F(); }); v = {}; x = 0; n = !1; }
                function f() { var a = g.throttleEvaluation; a && 0 <= a ? (clearTimeout(t), t = setTimeout(h, a)) : g.wa ? g.wa() : h(); }
                function h() {
                    if (!r && !q) {
                        if (y && y()) {
                            if (!m) {
                        ...
                        try {
                            var b = v, d = x;
                            a.k.jb({ za: function (a, c) { q || (d && b[c] ? (v[c] = b[c], ++x, delete b[c], --d) : v[c] || (v[c] = a.V(f), ++x)); }, ba: g, pa: !x });
                            v = {};
                            x = 0;
                            try {
                                var e = c ? s.call(c) : s();
                ...
                a.N.call(g);
                a.a.sa(g, a.h.fn);
                g.o = function () { n && !x && h(); return l; };
                g.fa = function () { return x; };
                g.Yb = "function" === typeof d.write;
                g.F = function () { p(); };
                g.ga = k;
                var w = g.Ma;
                g.Ma = function (a) { w.call(g, a); g.wa = function () { g.bb(l); n = !0; g.cb(g); }; };
                a.s(g, "peek", g.o);
                a.s(g, "dispose", g.F);
                a.s(g, "isActive", g.ga);
                ...
                u && k() && u.nodeType && (p = function () { a.a.u.Ab(u, p); e(); }, a.a.u.ja(u, p));
                return g;
            };
            ...
            a.b("isComputed", a.$b);
            (function () {
                function b(a, f, h) { h = h || new d; a = f(a); if ("object" != typeof a || null === a || a === p || a instanceof Date || a instanceof String || a instanceof Number || a instanceof Boolean)
                    return a; var g = a instanceof Array ? [] : {}; h.save(a, g); c(a, function (c) { var d = f(a[c]); switch (typeof d) {
                    case "boolean":
                    case "number":
                    case "string":
                    case "function":
                ...
                function d() { this.keys = []; this.ab = []; }
                a.Gb = function (c) { if (0 == arguments.length)
                    throw Error("When calling ko.toJS, pass the object you want to convert."); return b(c, function (b) { for (var c = 0; a.v(b) && 10 > c; c++)
                    b = b(); return b; }); };
                a.toJSON = function (b, c, d) { b = a.Gb(b); return a.a.Ya(b, c, d); };
                d.prototype = { save: function (b, c) { var d = a.a.l(this.keys, b); 0 <= d ? this.ab[d] = c : (this.keys.push(b), this.ab.push(c)); }, get: function (b) {
                        b = a.a.l(this.keys, b);
            ...
            a.b("toJSON", a.toJSON);
            (function () {
                a.i = { p: function (b) { switch (a.a.B(b)) {
                        case "option": return !0 === b.__ko__hasDomDataOptionValue__ ? a.a.f.get(b, a.d.options.Pa) : 7 >= a.a.oa ? b.getAttributeNode("value") && b.getAttributeNode("value").specified ? b.value : b.text : b.value;
            ...
            a.g = function () {
                ...
                return { aa: [], W: g, Ra: b, qa: function (e, l) {
                        function f(b, e) {
                        ...
                        for (var c = 0; c < a.length; c++)
                            if (a[c].key == b)
                                return !0;
                        return !1;
                    }, va: function (b, c, d, e, g) { if (b && a.v(b))
                        !a.ub(b) || g && b.o() === e || b(e);
            ...
            (function () {
                ...
                function d(a, d) { for (var e = a, g = 1, k = []; e = e.nextSibling;) {
                    if (c(e) && (g--, 0 === g))
                        return k;
                    k.push(e);
                    b(e) && g++;
                ...
                a.e = { Q: {}, childNodes: function (a) { return b(a) ? d(a) : a.childNodes; }, da: function (c) { if (b(c)) {
                        c = a.e.childNodes(c);
                        for (var d = 0, e = c.length; d < e; d++)
                            a.removeNode(c[d]);
                    }
                    else
                        a.a.Fa(c); }, U: function (c, d) { if (b(c)) {
                        a.e.da(c);
            ...
            (function () {
                ...
                a.a.extend(a.J.prototype, { nodeHasBindings: function (b) { switch (b.nodeType) {
                        case 1: return null != b.getAttribute("data-bind");
                        case 8: return a.e.Xb(b);
                        default: return !1;
                    } }, getBindings: function (a, c) { var d = this.getBindingsString(a, c); return d ? this.parseBindingsString(d, c, a) : null; }, getBindingAccessors: function (a, c) { var d = this.getBindingsString(a, c); return d ? this.parseBindingsString(d, c, a, { valueAccessors: !0 }) : null; }, getBindingsString: function (b) {
                        switch (b.nodeType) {
                            case 1: return b.getAttribute("data-bind");
                            case 8: return a.e.lc(b);
                            default: return null;
                        }
                    }, parseBindingsString: function (b, c, d, e) { try {
            ...
            (function () {
                ...
                function f(b, c, d) { var e, g = a.e.firstChild(c), k = a.J.instance, f = k.preprocessNode; if (f) {
                    for (; e = g;)
                        g = a.e.nextSibling(e), f.call(k, e);
                    g = a.e.firstChild(c);
                } for (; e = g;)
                    g = a.e.nextSibling(e), h(b, e, d); }
                function h(b, c, d) { var e = !0, g = 1 === c.nodeType; g && a.e.wb(c); if (g && d || a.J.instance.nodeHasBindings(c))
                    e = k(c, null, b, d).shouldBindDescendants; e && !n[a.a.B(c)] && f(b, c, !g); }
                function g(b) {
                    var c = [], d = {}, e = [];
                    a.a.A(b, function y(g) { if (!d[g]) {
                        var k = a.getBindingHandler(g);
                        k && (k.after && (e.push(g), a.a.r(k.after, function (c) { if (b[c]) {
                            if (-1 !== a.a.l(e, c))
                ...
                function k(b, d, k, f) {
                    ...
                    if (d && "function" !==
                        ...
                        var n = a.J.instance, m = n.getBindingAccessors || e, x = a.h(function () { (l = d ? d(k, b) : m.call(n, b, k)) && k.D && k.D(); return l; }, null, { G: b });
                        l && x.ga() || (x = null);
                    }
                    var t;
                    if (l) {
                        ...
                        a.a.r(f, function (c) {
                            ...
                            try {
                                "function" == typeof d && a.k.t(function () { var a = d(b, w(g), z, k.$data, k); if (a && a.controlsDescendantBindings) {
                                    if (t !== p)
                ...
                a.I = function (b, c, d, e) {
                    var g = this, k = "function" == typeof b && !a.v(b), f, h = a.h(function () { var f = k ? b() : b, l = a.a.c(f); c ? (c.D && c.D(), a.a.extend(g, c), h && (g.D = h)) : (g.$parents = [], g.$root = l, g.ko = a); g.$rawData = f; g.$data = l; d && (g[d] = l); e && e(g, c, l); return g.$data; }, null, { Da: function () { return f && !a.a.eb(f); }, G: !0 });
                    h.ga() && (g.D = h, h.equalityComparer = null, f = [], h.Jb = function (b) {
                        f.push(b);
                        a.a.u.ja(b, function (b) { a.a.ma(f, b); f.length || (h.F(), g.D = h = p); });
                    });
                };
                a.I.prototype.createChildContext = function (b, c, d) { return new a.I(b, this, c, function (a, b) { a.$parentContext = b; a.$parent = b.$data; a.$parents = (b.$parents || []).slice(0); a.$parents.unshift(a.$parent); d && d(a); }); };
                a.I.prototype.extend = function (b) { return new a.I(this.D || this.$data, this, null, function (c, d) { c.$rawData = d.$rawData; a.a.extend(c, "function" == typeof b ? b() : b); }); };
                ...
                a.xa = function (b, c, d) { 1 === b.nodeType && a.e.wb(b); return k(b, c, l(d), !0); };
                a.Lb = function (c, e, g) { g = l(g); return a.xa(c, "function" === typeof e ? d(e.bind(null, g, c)) : a.a.Oa(e, b), g); };
            ...
            a.d.attr = { update: function (b, c) {
                    var d = a.a.c(c()) || {};
                    a.a.A(d, function (c, d) { d = a.a.c(d); var h = !1 === d || null === d || d === p; h && b.removeAttribute(c); 8 >= a.a.oa && c in L ? (c = L[c], h ? b.removeAttribute(c) : b[c] = d) : h || b.setAttribute(c, d.toString()); "name" === c && a.a.Cb(b, h ? "" : d.toString()); });
                } };
            (function () {
                a.d.checked = { after: ["value", "attr"], init: function (b, c, d) {
                        ...
                        function h() { var d = a.a.c(c()); b.checked = l ? 0 <= a.a.l(d, e()) : g ? d : e() === d; }
            ...
            a.d.css = { update: function (b, c) {
                    var d = a.a.c(c());
                    "object" == typeof d ? a.a.A(d, function (c, d) { d = a.a.c(d); a.a.ua(b, c, d); }) : (d = String(d ||
            ...
            a.d.foreach = { vb: function (b) { return function () { var c = b(), d = a.a.Sa(c); if (!d || "number" == typeof d.length)
                    return { foreach: c, templateEngine: a.K.Ja }; a.a.c(c); return { foreach: d.data, as: d.as, includeDestroyed: d.includeDestroyed, afterAdd: d.afterAdd, beforeRemove: d.beforeRemove, afterRender: d.afterRender, beforeMove: d.beforeMove, afterMove: d.afterMove, templateEngine: a.K.Ja }; }; }, init: function (b, c) { return a.d.template.init(b, a.d.foreach.vb(c)); }, update: function (b, c, d, e, f) { return a.d.template.update(b, a.d.foreach.vb(c), d, e, f); } };
            a.g.aa.foreach = !1;
            a.e.Q.foreach = !0;
            a.d.hasfocus = { init: function (b, c, d) {
                    function e(e) { b.__ko_hasfocusUpdating = !0; var k = b.ownerDocument; if ("activeElement" in k) {
                        var f;
                        try {
                            f = k.activeElement;
                        }
                        ...
                        e = f === b;
                    } k = c(); a.g.va(k, d, "hasfocus", e, !0); b.__ko_hasfocusLastValue = e; b.__ko_hasfocusUpdating = !1; }
            ...
            a.d.options = { init: function (b) {
                    ...
                    k = h;
                    d.has("optionsAfterRender") && (k = function (b, c) { h(0, c); a.k.t(d.get("optionsAfterRender"), null, [c[0], b !== J ? b : p]); });
            ...
            a.d.selectedOptions = { after: ["options", "foreach"], init: function (b, c, d) { a.a.q(b, "change", function () { var e = c(), f = []; a.a.r(b.getElementsByTagName("option"), function (b) { b.selected && f.push(a.i.p(b)); }); a.g.va(e, d, "selectedOptions", f); }); }, update: function (b, c) {
                    if ("select" != a.a.B(b))
            ...
            a.d.style = { update: function (b, c) { var d = a.a.c(c() || {}); a.a.A(d, function (c, d) { d = a.a.c(d); b.style[c] = d || ""; }); } };
            a.d.submit = { init: function (b, c, d, e, f) { if ("function" != typeof c())
                    throw Error("The value for a submit binding must be a function"); a.a.q(b, "submit", function (a) { var d, e = c(); try {
                    d = e.call(f.$data, b);
                }
                finally {
            ...
            a.e.Q.text = !0;
            a.d.uniqueName = { init: function (b, c) { if (c()) {
                    var d = "ko_unique_" + ++a.d.uniqueName.Ob;
                    a.a.Cb(b, d);
                } } };
            a.d.uniqueName.Ob = 0;
            a.d.value = { after: ["options", "foreach"], init: function (b, c, d) {
                    function e() { g = !1; var e = c(), f = a.i.p(b); a.g.va(e, d, "value", f); }
                    ...
                    a.a.r(f, function (c) { var d = e; a.a.kc(c, "after") && (d = function () { setTimeout(e, 0); }, c = c.substring(5)); a.a.q(b, c, d); });
                }, update: function (b, c, d) { var e = a.a.c(c()); c = a.i.p(b); if (e !== c)
                    if ("select" === a.a.B(b)) {
            ...
            a.g.W.value = !0;
            a.d.visible =
                { update: function (b, c) { var d = a.a.c(c()), e = "none" != b.style.display; d && !e ? b.style.display = "" : !d && e && (b.style.display = "none"); } };
            (function (b) { a.d[b] = { init: function (c, d, e, f, h) { return a.d.event.init.call(this, c, function () { var a = {}; a[b] = d(); return a; }, e, f, h); } }; })("click");
            a.C = function () { };
            ...
            a.C.prototype.makeTemplateSource =
                function (b, c) { if ("string" == typeof b) {
                    c = c || w;
                    ...
                    return new a.n.Z(b); throw Error("Unknown template type: " + b); };
            a.C.prototype.renderTemplate = function (a, c, d, e) { a = this.makeTemplateSource(a, e); return this.renderTemplateSource(a, c, d); };
            ...
            a.C.prototype.rewriteTemplate =
                function (a, c, d) { a = this.makeTemplateSource(a, d); c = c(a.text()); a.text(c); a.data("isRewritten", !0); };
            ...
            a.Za = function () {
                ...
                return { Ub: function (b, c, d) { c.isTemplateRewritten(b, d) || c.rewriteTemplate(b, function (b) { return a.Za.dc(b, c); }, d); }, dc: function (a, f) {
            ...
            (function () {
                ...
                a.n.j.prototype.text = function () { var b = a.a.B(this.j), b = "script" === b ? "text" : "textarea" === b ? "value" : "innerHTML"; if (0 == arguments.length)
                    return this.j[b]; var c = arguments[0]; "innerHTML" === b ? a.a.Va(this.j, c) : this.j[b] = c; };
                var b = a.a.f.L() + "_";
                ...
                a.n.Z.prototype.text = function () { if (0 == arguments.length) {
                    var b = a.a.f.get(this.j, c) || {};
                    b.$a === p && b.Ba && (b.$a = b.Ba.innerHTML);
                    return b.$a;
                } a.a.f.set(this.j, c, { $a: arguments[0] }); };
                a.n.j.prototype.nodes = function () { if (0 == arguments.length)
                    return (a.a.f.get(this.j, c) || {}).Ba; a.a.f.set(this.j, c, { Ba: arguments[0] }); };
                a.b("templateSources", a.n);
                a.b("templateSources.domElement", a.n.j);
                a.b("templateSources.anonymousTemplate", a.n.Z);
            })();
            (function () {
                function b(b, c, d) { var e; for (c = a.e.nextSibling(c); b && (e = b) !== c;)
                    b = a.e.nextSibling(e), d(e, b); }
                function c(c, d) {
                    if (c.length) {
                        var e = c[0], f = c[c.length - 1], h = e.parentNode, m = a.J.instance, q = m.preprocessNode;
                        if (q) {
                            b(e, f, function (a, b) { var c = a.previousSibling, d = q.call(m, a); d && (a === e && (e = d[0] || b), a === f && (f = d[d.length - 1] || c)); });
                            c.length = 0;
                            if (!e)
                                return;
                ...
                var f;
                a.Wa = function (b) { if (b != p && !(b instanceof a.C))
                    throw Error("templateEngine must inherit from ko.templateEngine"); f = b; };
                ...
                a.jc = function (b, d, f, h, r) {
                    function m(a, b) { c(b, s); f.afterRender && f.afterRender(b, a); }
                    function q(a, c) { s = r.createChildContext(a, f.as, function (a) { a.$index = c; }); var d = "function" == typeof b ? b(a, s) : b; return e(null, "ignoreTargetNode", d, s, f); }
                    var s;
                    return a.h(function () {
                        var b = a.a.c(d) || [];
                ...
                var h = a.a.f.L();
                a.d.template = { init: function (b, c) { var d = a.a.c(c()); "string" == typeof d || d.name ? a.e.da(b) : (d = a.e.childNodes(b), d = a.a.ec(d), (new a.n.Z(b)).nodes(d)); return { controlsDescendantBindings: !0 }; }, update: function (b, c, d, e, f) {
                        var m = c(), q;
                        c = a.a.c(m);
                        d = !0;
                        e = null;
                ...
                a.g.aa.template = function (b) { b = a.g.Ra(b); return 1 == b.length && b[0].unknown || a.g.bc(b, "name") ? null : "This template engine does not support anonymous templates nested within its templates"; };
                a.e.Q.template = !0;
            })();
            ...
            (function () {
                ...
                a.a.Ua = function (d, e, f, h, g) {
                    function k(b, c) { v = r[c]; u !== c && (z[b] = v); v.Ia(u++); a.a.ea(v.S, d); s.push(v); y.push(v); }
                    function l(b, c) { if (b)
                        for (var d = 0, e = c.length; d < e; d++)
                            c[d] && a.a.r(c[d].S, function (a) { b(a, d, c[d].ka); }); }
                    e = e || [];
                    h = h || {};
            ...
            a.K.prototype.renderTemplateSource = function (b) { var c = (9 > a.a.oa ? 0 : b.nodes) ? b.nodes() : null; if (c)
                return a.a.R(c.cloneNode(!0).childNodes); b = b.text(); return a.a.Qa(b); };
            a.K.Ja = new a.K;
            a.Wa(a.K.Ja);
